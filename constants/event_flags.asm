...
; Johto story events
	...
	const EVENT_GOT_GBC_SOUNDS_FROM_RADIO_TOWER
	...
	const EVENT_GOT_ODD_SOUVENIR_FROM_ELM
	...
	const EVENT_ELM_WANTS_TO_BATTLE
	const EVENT_GOT_CLEAR_AMULET_IN_AZALEA
	const EVENT_INTRODUCED_PIERS
	const EVENT_GOT_THROAT_SPRAY_FROM_PIERS
	const EVENT_GOT_RARE_CANDY_FROM_KIMONO_GIRL_MAKO
	const EVENT_GOT_PP_MAX_FROM_KIMONO_GIRL_AMI
	const EVENT_GOT_ABILITYPATCH_FROM_KIMONO_GIRL_MINA
	const EVENT_GOT_LOADED_DICE_FROM_GOLDENROD
	const EVENT_CAUGHT_HISUIAN_TYPHLOSION
	const EVENT_TALKED_TO_VIOLET_CEMETERY_CARETAKER
	const EVENT_GOT_CANDY_JAR
	const EVENT_GOT_RARE_CANDY_FROM_RUGGED_ROAD_GATE
	...
	const EVENT_LISTENED_TO_AGILITY_INTRO
	const EVENT_LISTENED_TO_BATON_PASS_INTRO
	const EVENT_LISTENED_TO_CHARM_INTRO
...
; Johto hidden items
	...
	const EVENT_UNION_CAVE_B1F_SOUTH_HIDDEN_X_SP_DEF
	const EVENT_UNION_CAVE_B1F_SOUTH_HIDDEN_NUGGET
	const EVENT_UNION_CAVE_B1F_SOUTH_HIDDEN_FULL_RESTORE
	const EVENT_UNION_CAVE_B2F_HIDDEN_CALCIUM
	const EVENT_UNION_CAVE_B2F_HIDDEN_ULTRA_BALL
	...
	const EVENT_WAREHOUSE_ENTRANCE_HIDDEN_X_SP_ATK
	...
	const EVENT_ROUTE_32_HIDDEN_GREAT_BALL_2
	const EVENT_ROUTE_32_HIDDEN_SUPER_POTION_2
	const EVENT_ROUTE_32_HIDDEN_GOLD_LEAF
	...
	const EVENT_ROUTE_35_HIDDEN_NUGGET
	const EVENT_ROUTE_35_COAST_SOUTH_HIDDEN_STAR_PIECE
	...
	const EVENT_CHERRYGROVE_CITY_HIDDEN_NUGGET
	...
	const EVENT_ECRUTEAK_CITY_HIDDEN_RARE_CANDY
	const EVENT_ECRUTEAK_CITY_HIDDEN_ULTRA_BALL
	const EVENT_ECRUTEAK_CITY_HIDDEN_ETHER
	const EVENT_OLIVINE_CITY_HIDDEN_RARE_CANDY
	const EVENT_ROUTE_35_COAST_NORTH_HIDDEN_BIG_PEARL
	const EVENT_ROUTE_35_COAST_NORTH_HIDDEN_SOFT_SAND
	...
	const EVENT_CLIFF_EDGE_GATE_HIDDEN_OVAL_STONE
	...
	const EVENT_MURKY_SWAMP_HIDDEN_X_SP_DEF
	...
	const EVENT_MAGNET_TUNNEL_HIDDEN_METAL_POWDER
	const EVENT_RUGGED_ROAD_SOUTH_HIDDEN_IRON
	const EVENT_RUGGED_ROAD_NORTH_HIDDEN_RARE_BONE
	const EVENT_SNOWTOP_MOUNTAIN_INSIDE_HIDDEN_ZINC
...
; Crystal-exclusive events in Johto
	...
	const EVENT_GOT_LINKING_CORD_FROM_PROF_OAKS_AIDE
	...
	const EVENT_GOT_HONEY_FROM_GOLDENROD
...
; Kanto story events
	...
	const EVENT_GOT_TM57_WILD_CHARGE
	...
	const EVENT_GOT_X_SP_ATK_IN_UNIVERSITY
	...
	const EVENT_LISTENED_TO_TRICK_ROOM_INTRO
...
; Orange story events
	...
	const EVENT_INTRODUCED_KATY
	const EVENT_GOT_SWEET_HONEY_FROM_KATY
	const EVENT_LISTENED_TO_BODY_SLAM_INTRO
	const EVENT_LISTENED_TO_ENDURE_INTRO
...
; Kanto hidden items
	...
	const EVENT_UNDERGROUND_HIDDEN_X_SP_ATK
	...
	const EVENT_ROUTE_24_HIDDEN_MAX_POTION
	...
	const EVENT_DIM_CAVE_5F_HIDDEN_X_SP_ATK
...
; Youngster
	...
	const EVENT_BEAT_YOUNGSTER_ARDEN
; Bug Catcher
...
; Nurse
	const EVENT_BEAT_NURSE_BEATRICE
	const EVENT_BEAT_NURSE_KEIKO
; Pokemaniac
	...
	const EVENT_BEAT_POKEMANIAC_ENZO
...
; Cosplayer
	...
	const EVENT_BEAT_COSPLAYER_LYRIC
; Super Nerd
	...
	const EVENT_BEAT_SUPER_NERD_KOUTA
...
; Kimono Girl
	...
	const EVENT_BEAT_KIMONO_GIRL_MAKO
	const EVENT_BEAT_KIMONO_GIRL_AMI
	const EVENT_BEAT_KIMONO_GIRL_MINA
; Elder
...
; Rich Boy
	...
	const EVENT_BEAT_RICH_BOY_TOBIN
; Lady
...
; Swimmer F
	...
	const EVENT_BEAT_SWIMMERF_MAYU
...
; Blackbelt T
	...
	const EVENT_BEAT_BLACKBELT_RYLAN
; Battle Girl
...
; Engineer
	...
	const EVENT_BEAT_ENGINEER_GRADEN
	const EVENT_BEAT_ENGINEER_GUSTAV
	const EVENT_BEAT_ENGINEER_NICOLAS
; Teacher
...
; CooltrainerM
	...
	const EVENT_BEAT_COOL_DUDE_DARIC
; CooltrainerF
...
; VeteranF
	...
	const EVENT_BEAT_VETERANF_JONET
...
; Marlon
	...
	const EVENT_BEAT_MARLON_AGAIN
; Valerie
	const EVENT_BEAT_VALERIE
; Kukui
	const EVENT_BEAT_KUKUI
; Piers
	const EVENT_BEAT_PIERS
	const EVENT_BEAT_PIERS_AGAIN
; Katy
	const EVENT_BEAT_KATY
; Victor
...
; Johto itemballs
	...
	const EVENT_OLIVINE_LIGHTHOUSE_6F_WIDE_LENS
	const EVENT_ROUTE_41_SILVER_LEAF
	...
	const EVENT_TEAM_ROCKET_BASE_B3F_X_SP_DEF
	...
	const EVENT_ROUTE_35_COAST_SOUTH_BIG_PEARL
	...
	const EVENT_MAGNET_TUNNEL_TM_GYRO_BALL
	const EVENT_RUGGED_ROAD_SOUTH_IRON_BALL
	const EVENT_RUGGED_ROAD_SOUTH_REVIVE
	const EVENT_RUGGED_ROAD_NORTH_X_ATTACK
	const EVENT_RUGGED_ROAD_NORTH_HYPER_POTION
	const EVENT_SNOWTOP_MOUNTAIN_INSIDE_ETHER
	const EVENT_SNOWTOP_MOUNTAIN_INSIDE_HEAVY_BOOTS
	const EVENT_SNOWTOP_MOUNTAIN_INSIDE_COVERT_CLOAK
...
; Johto people
	...
	const EVENT_FAST_SHIP_MADE_FIRST_TRIP
	...
	const EVENT_MURKY_SWAMP_BLOODMOON_URSALUNA
	const EVENT_QUIET_CAVE_MARLEY
	const EVENT_VIOLET_CEMETERY_CARETAKER
...
; Kanto itemballs
	...
	const EVENT_CELADON_HOTEL_ROOM_3_ROOM_SERVICE
	...
	const EVENT_OLIVINE_PORT_GO_GOGGLES
	...
	const EVENT_SCARY_CAVE_1F_X_SP_DEF
	...
	const EVENT_ROCKET_HIDEOUT_B1F_MOON_STONE
	const EVENT_ROCKET_HIDEOUT_B1F_ZINC
	const EVENT_ROCKET_HIDEOUT_B2F_ULTRA_BALL
	const EVENT_ROCKET_HIDEOUT_B2F_SUPER_REPEL
	const EVENT_ROCKET_HIDEOUT_B2F_NUGGET
	const EVENT_ROCKET_HIDEOUT_B2F_RARE_CANDY
	const EVENT_ROCKET_HIDEOUT_B3F_CARBOS
	const EVENT_ROCKET_HIDEOUT_B3F_ELIXIR
	const EVENT_ROCKET_HIDEOUT_B4F_LIFT_KEY
	const EVENT_ROCKET_HIDEOUT_B4F_X_SP_ATK
	const EVENT_ROCKET_HIDEOUT_B4F_PP_UP
	const EVENT_ROCKET_HIDEOUT_B4F_DUBIOUS_DISC
...
; Orange people
	const EVENT_SHAMOUTI_ISLAND_ALOLAN_EXEGGUTOR
...
; New to Crystal
	...
	const EVENT_EUSINES_HOUSE_EUSINE
	...
	const EVENT_ICE_PATH_1F_HEAT_ROCK
	...
	const EVENT_RADIO_TOWER_5F_ZOOM_LENS
...
; Pikachu Edition
    const EVENT_LISTENED_TO_ERIKA_INTRO
    const EVENT_GOT_ERIKA_BULBASAUR
    const EVENT_LISTENED_TO_BLAINE_INTRO
    const EVENT_GOT_BLAINE_CHARMANDER
    const EVENT_LISTENED_TO_MISTY_INTRO
    const EVENT_GOT_MISTY_SQUIRTLE
    const EVENT_GOT_SURGE_LIGHT_BALL
    const EVENT_PIKACHU_POKEBALL_IN_ELMS_LAB
    const EVENT_GOT_PIKACHU_FROM_ELM
    const EVENT_ROUTE39_MUNCHLAX
...
; Cut trees
	...
	const EVENT_ROUTE_16_WEST_CUT_TREE
