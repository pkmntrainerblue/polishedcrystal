...
endc
	...
	move SPLASHY_SURF,    EFFECT_PARALYZE_HIT,       90, WATER,     100, 15,  30, SPECIAL
	...
	move PIKA_PAPOW,      EFFECT_RETURN,              1, ELECTRIC,   -1, 20,   0, SPECIAL
...
endc
	move RISING_VOLT,     EFFECT_RISING_VOLT,        70, ELECTRIC,   100, 20,  0, SPECIAL
	...
	move FLOATY_FALL,     EFFECT_FLINCH_HIT,         90, FLYING,     95, 15,  30, PHYSICAL
	...
	move WILD_CHARGE,     EFFECT_RECOIL_HIT,        120, ELECTRIC,  100, 15,   0, PHYSICAL
