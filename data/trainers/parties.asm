...
endc
	...
	tr_mon 71, MAROWAK @ THICK_CLUB, MALE | ALOLAN_FORM
		tr_moves EARTHQUAKE, STONE_EDGE, ICE_PUNCH, SHADOW_CLAW
...
endc
	...
	tr_mon 72, HITMONLEE @ QUICK_CLAW, MALE
		tr_extra RECKLESS
		tr_moves SUCKER_PUNCH, BULK_UP, REVERSAL, CLOSE_COMBAT
...
PryceGroup:
	...
	tr_mon 38, SNEASEL
		tr_evs 224 Atk
		tr_moves SWORDS_DANCE, ICE_PUNCH, SCREECH, SLASH
	tr_mon 38, CLOYSTER
		tr_evs 224 HP
	...
	tr_mon 73, CLOYSTER @ KINGS_ROCK
		tr_moves SPIKES, SURF, EXPLOSION, ICICLE_SPEAR
...
BrunoGroup:
	...
	tr_mon 51, HITMONLEE @ FOCUS_BAND
		tr_evs 176 Atk, 176 Spe
		tr_moves SUCKER_PUNCH, DOUBLE_KICK, CLOSE_COMBAT, FORESIGHT
	...
	tr_mon 70, HITMONTOP @ QUICK_CLAW
		tr_moves BULK_UP, SUCKER_PUNCH, COUNTER, CLOSE_COMBAT
	tr_mon 71, SNEASLER @ SILVERPOWDER
		tr_moves SWORDS_DANCE, X_SCISSOR, CLOSE_COMBAT, GUNK_SHOT
	tr_mon 70, HITMONLEE @ FOCUS_BAND
		tr_moves BULK_UP, SUCKER_PUNCH, CLOSE_COMBAT, REVERSAL
...
MistyGroup:
	...
	tr_mon 60, KINGLER
		...
		tr_moves DEFENSE_CURL, STOMP, PROTECT, WATERFALL
	tr_mon 62, LANTURN
	...
	tr_mon 72, KINGLER @ KINGS_ROCK
		tr_moves SWORDS_DANCE, WATERFALL, X_SCISSOR, ROCK_SLIDE
...
LtSurgeGroup:
	...
	tr_mon 58, ELECTABUZZ @ EVIOLITE, MALE
	...
	tr_mon 57, MAGNEZONE, MALE
		tr_evs 36 HP, 252 SAt
		tr_moves LIGHT_SCREEN, DOUBLE_TEAM, WILD_CHARGE, THUNDER
	tr_mon 56, ELECTRODE, MALE
	...
	tr_mon 60, RAICHU @ AIR_BALLOON, MALE
		...
		tr_extra ELECTRIC_SURGE, ATK_UP_DEF_DOWN
        tr_moves THUNDER, EXTREMESPEED, WILD_CHARGE, SURF
	end_trainer
...
Rival2Group:
	...
	tr_mon 61, MAGNEZONE @ MAGNET
		...
		tr_moves TRI_ATTACK, THUNDER, THUNDER_WAVE, FLASH_CANNON
...
FisherGroup:
	...
	tr_mon 42, OCTILLERY
		tr_moves PSYBEAM, AURORA_BEAM, WATERFALL, HYPER_BEAM
	end_trainer
...
SchoolboyGroup:
	...
	tr_mon 38, MAGNETON
		tr_moves THUNDER, THUNDER_WAVE, SUPERSONIC, SWIFT
	end_trainer
...
BreederGroup:
	...
	tr_mon 27, TYROGUE @ EVIOLITE
		tr_moves TACKLE, RAGE, FORESIGHT, CLOSE_COMBAT
...
;	tr_mon 36, HITMONLEE
;		tr_moves DOUBLE_TEAM, CLOSE_COMBAT, MUD_SLAP, SWIFT
;	end_trainer

	def_trainer YOSHI, "Yoshi"
	tr_mon 27, "Bruce", HITMONLEE
		tr_moves DOUBLE_KICK, BULK_UP, CLOSE_COMBAT, FOCUS_ENERGY
	end_trainer
...
ProtonGroup:
	...
	tr_mon 40, OCTILLERY @ LUM_BERRY
		tr_moves WATERFALL, POWER_WHIP, FLAMETHROWER, ICE_BEAM
...
ProfOakGroup:
	...
	tr_mon 76, DODRIO @ BERSERK_GENE, FEMALE
		...
		tr_moves BRAVE_BIRD, CLOSE_COMBAT, KNOCK_OFF, QUICK_ATTACK
...
KarateKingGroup:
	...
	tr_mon LEVEL_FROM_BADGES + 11, HITMONLEE @ BLACK_BELT
		tr_moves BULK_UP, FOCUS_ENERGY, CLOSE_COMBAT, FORESIGHT
...
LoreleiGroup:
	...
	tr_mon 72, CLOYSTER @ MUSCLE_BAND
		tr_moves EXPLOSION, ROCK_BLAST, ICICLE_SPEAR, BARRIER
	...
	tr_mon 57, CLOYSTER @ SILK_SCARF
		tr_evs 252 Atk, 68 Spe
		tr_moves EXPLOSION, ROLLOUT, ICICLE_SPEAR, BARRIER
...
if DEF(FAITHFUL)
	...
	tr_mon 61, MAROWAK @ THICK_CLUB, FEMALE | ALOLAN_FORM
		...
		tr_moves SWORDS_DANCE, EARTHQUAKE, FIRE_PUNCH, SHADOW_CLAW
endc
...
if DEF(FAITHFUL)
	...
	tr_mon 72, MAROWAK @ THICK_CLUB, FEMALE | ALOLAN_FORM
		tr_moves SWORDS_DANCE, EARTHQUAKE, ROCK_SMASH, SHADOW_CLAW
endc
...
endc
	tr_mon 58, SANDSLASH @ NEVERMELTICE, MALE | ALOLAN_FORM
		tr_moves IRON_HEAD, ICE_PUNCH, EARTHQUAKE, RAPID_SPIN
