...
ChampionGroup:
	...
	tr_mon 58, DRAGONAIR @ WIDE_LENS, MALE
		tr_extra MARVEL_SCALE, SATK_UP_ATK_DOWN
...
endc
	...
	tr_mon LEVEL_FROM_BADGES + 8, GYARADOS @ FOCUS_SASH, MALE
		tr_extra INTIMIDATE, ATK_UP_SATK_DOWN
		tr_evs 252 Atk, 12 Spe
		tr_moves DRAGON_DANCE, OUTRAGE, EARTHQUAKE, AQUA_TAIL
...
endc
	...
	def_trainer EN, "En"
	tr_mon 60, GYARADOS @ MUSCLE_BAND
		tr_moves OUTRAGE, DRAGON_DANCE, FLY, EARTHQUAKE
...
TowerTycoonGroup:
	...
	tr_mon 75, KINGDRA @ WISE_GLASSES
		tr_moves HYDRO_PUMP, DRAGON_PULSE, HYPER_BEAM, BLIZZARD
