...
NidoranMMiniMask:: INCBIN "gfx/minis/nidoran_m_mask.1bpp.lz"
NidoranMIcon::     INCBIN "gfx/icons/nidoran_m.2bpp.lz"

SECTION "Nidorino Mini Icon", ROMX
NidorinoMini::     INCBIN "gfx/minis/nidorino.2bpp.lz"
NidorinoMiniMask:: INCBIN "gfx/minis/nidorino_mask.1bpp.lz"
NidorinoIcon::     INCBIN "gfx/icons/nidorino.2bpp.lz"

SECTION "Nidoking Mini Icon", ROMX
NidokingMini::     INCBIN "gfx/minis/nidoking.2bpp.lz"
NidokingMiniMask:: INCBIN "gfx/minis/nidoking_mask.1bpp.lz"
NidokingIcon::     INCBIN "gfx/icons/nidoking.2bpp.lz"

SECTION "Clefairy Mini Icon", ROMX
ClefairyMini::     INCBIN "gfx/minis/clefairy.2bpp.lz"
ClefairyMiniMask:: INCBIN "gfx/minis/clefairy_mask.1bpp.lz"
ClefairyIcon::     INCBIN "gfx/icons/clefairy.2bpp.lz"

SECTION "Clefable Mini Icon", ROMX
ClefableMini::     INCBIN "gfx/minis/clefable.2bpp.lz"
ClefableMiniMask:: INCBIN "gfx/minis/clefable_mask.1bpp.lz"
ClefableIcon::     INCBIN "gfx/icons/clefable.2bpp.lz"

SECTION "Vulpix Mini Icon", ROMX
VulpixMini::     INCBIN "gfx/minis/vulpix.2bpp.lz"
VulpixMiniMask:: INCBIN "gfx/minis/vulpix_mask.1bpp.lz"
VulpixIcon::     INCBIN "gfx/icons/vulpix.2bpp.lz"

SECTION "Ninetales Mini Icon", ROMX
NinetalesMini::     INCBIN "gfx/minis/ninetales.2bpp.lz"
NinetalesMiniMask:: INCBIN "gfx/minis/ninetales_mask.1bpp.lz"
NinetalesIcon::     INCBIN "gfx/icons/ninetales.2bpp.lz"

SECTION "Jigglypuff Mini Icon", ROMX
JigglypuffMini::     INCBIN "gfx/minis/jigglypuff.2bpp.lz"
JigglypuffMiniMask:: INCBIN "gfx/minis/jigglypuff_mask.1bpp.lz"
JigglypuffIcon::     INCBIN "gfx/icons/jigglypuff.2bpp.lz"

SECTION "Wigglytuff Mini Icon", ROMX
WigglytuffMini::     INCBIN "gfx/minis/wigglytuff.2bpp.lz"
WigglytuffMiniMask:: INCBIN "gfx/minis/wigglytuff_mask.1bpp.lz"
WigglytuffIcon::     INCBIN "gfx/icons/wigglytuff.2bpp.lz"

SECTION "Zubat Mini Icon", ROMX
ZubatMini::     INCBIN "gfx/minis/zubat.2bpp.lz"
ZubatMiniMask:: INCBIN "gfx/minis/zubat_mask.1bpp.lz"
ZubatIcon::     INCBIN "gfx/icons/zubat.2bpp.lz"

SECTION "Golbat Mini Icon", ROMX
GolbatMini::     INCBIN "gfx/minis/golbat.2bpp.lz"
...
SECTION "Parasect Mini Icon", ROMX
ParasectMini::     INCBIN "gfx/minis/parasect.2bpp.lz"
...
SECTION "Persian Mini Icon", ROMX
PersianMini::     INCBIN "gfx/minis/persian.2bpp.lz"
PersianMiniMask:: INCBIN "gfx/minis/persian_mask.1bpp.lz"
PersianIcon::     INCBIN "gfx/icons/persian.2bpp.lz"

SECTION "Psyduck Mini Icon", ROMX
PsyduckMini::     INCBIN "gfx/minis/psyduck.2bpp.lz"
PsyduckMiniMask:: INCBIN "gfx/minis/psyduck_mask.1bpp.lz"
PsyduckIcon::     INCBIN "gfx/icons/psyduck.2bpp.lz"

SECTION "Golduck Mini Icon", ROMX
GolduckMini::     INCBIN "gfx/minis/golduck.2bpp.lz"
GolduckMiniMask:: INCBIN "gfx/minis/golduck_mask.1bpp.lz"
GolduckIcon::     INCBIN "gfx/icons/golduck.2bpp.lz"

SECTION "Mankey Mini Icon", ROMX
MankeyMini::     INCBIN "gfx/minis/mankey.2bpp.lz"
MankeyMiniMask:: INCBIN "gfx/minis/mankey_mask.1bpp.lz"
MankeyIcon::     INCBIN "gfx/icons/mankey.2bpp.lz"

SECTION "Primeape Mini Icon", ROMX
PrimeapeMini::     INCBIN "gfx/minis/primeape.2bpp.lz"
PrimeapeMiniMask:: INCBIN "gfx/minis/primeape_mask.1bpp.lz"
PrimeapeIcon::     INCBIN "gfx/icons/primeape.2bpp.lz"

SECTION "Growlithe Mini Icon", ROMX
GrowlitheMini::     INCBIN "gfx/minis/growlithe.2bpp.lz"
GrowlitheMiniMask:: INCBIN "gfx/minis/growlithe_mask.1bpp.lz"
GrowlitheIcon::     INCBIN "gfx/icons/growlithe.2bpp.lz"

SECTION "Arcanine Mini Icon", ROMX
ArcanineMini::     INCBIN "gfx/minis/arcanine.2bpp.lz"
ArcanineMiniMask:: INCBIN "gfx/minis/arcanine_mask.1bpp.lz"
ArcanineIcon::     INCBIN "gfx/icons/arcanine.2bpp.lz"

SECTION "Poliwag Mini Icon", ROMX
PoliwagMini::     INCBIN "gfx/minis/poliwag.2bpp.lz"
PoliwagMiniMask:: INCBIN "gfx/minis/poliwag_mask.1bpp.lz"
PoliwagIcon::     INCBIN "gfx/icons/poliwag.2bpp.lz"

SECTION "Poliwhirl Mini Icon", ROMX
PoliwhirlMini::     INCBIN "gfx/minis/poliwhirl.2bpp.lz"
PoliwhirlMiniMask:: INCBIN "gfx/minis/poliwhirl_mask.1bpp.lz"
PoliwhirlIcon::     INCBIN "gfx/icons/poliwhirl.2bpp.lz"

SECTION "Poliwrath Mini Icon", ROMX
PoliwrathMini::     INCBIN "gfx/minis/poliwrath.2bpp.lz"
...
GravelerMini::     INCBIN "gfx/minis/graveler.2bpp.lz"
GravelerMiniMask:: INCBIN "gfx/minis/graveler_mask.1bpp.lz"
GravelerIcon::     INCBIN "gfx/icons/graveler.2bpp.lz"

SECTION "Golem Mini Icon", ROMX
GolemMini::     INCBIN "gfx/minis/golem.2bpp.lz"
GolemMiniMask:: INCBIN "gfx/minis/golem_mask.1bpp.lz"
GolemIcon::     INCBIN "gfx/icons/golem.2bpp.lz"

SECTION "Ponyta Mini Icon", ROMX
PonytaMini::     INCBIN "gfx/minis/ponyta.2bpp.lz"
PonytaMiniMask:: INCBIN "gfx/minis/ponyta_mask.1bpp.lz"
PonytaIcon::     INCBIN "gfx/icons/ponyta.2bpp.lz"

SECTION "Rapidash Mini Icon", ROMX
RapidashMini::     INCBIN "gfx/minis/rapidash.2bpp.lz"
RapidashMiniMask:: INCBIN "gfx/minis/rapidash_mask.1bpp.lz"
RapidashIcon::     INCBIN "gfx/icons/rapidash.2bpp.lz"

SECTION "Slowpoke Mini Icon", ROMX
SlowpokeMini::     INCBIN "gfx/minis/slowpoke.2bpp.lz"
SlowpokeMiniMask:: INCBIN "gfx/minis/slowpoke_mask.1bpp.lz"
SlowpokeIcon::     INCBIN "gfx/icons/slowpoke.2bpp.lz"

SECTION "Slowbro Mini Icon", ROMX
SlowbroMini::     INCBIN "gfx/minis/slowbro.2bpp.lz"
SlowbroMiniMask:: INCBIN "gfx/minis/slowbro_mask.1bpp.lz"
SlowbroIcon::     INCBIN "gfx/icons/slowbro.2bpp.lz"

SECTION "Magnemite Mini Icon", ROMX
MagnemiteMini::     INCBIN "gfx/minis/magnemite.2bpp.lz"
MagnemiteMiniMask:: INCBIN "gfx/minis/magnemite_mask.1bpp.lz"
MagnemiteIcon::     INCBIN "gfx/icons/magnemite.2bpp.lz"

SECTION "Magneton Mini Icon", ROMX
MagnetonMini::     INCBIN "gfx/minis/magneton.2bpp.lz"
...
SECTION "Dewgong Mini Icon", ROMX
DewgongMini::     INCBIN "gfx/minis/dewgong.2bpp.lz"
DewgongMiniMask:: INCBIN "gfx/minis/dewgong_mask.1bpp.lz"
DewgongIcon::     INCBIN "gfx/icons/dewgong.2bpp.lz"

SECTION "Grimer Mini Icon", ROMX
GrimerMini::     INCBIN "gfx/minis/grimer.2bpp.lz"
GrimerMiniMask:: INCBIN "gfx/minis/grimer_mask.1bpp.lz"
GrimerIcon::     INCBIN "gfx/icons/grimer.2bpp.lz"

SECTION "Muk Mini Icon", ROMX
MukMini::     INCBIN "gfx/minis/muk.2bpp.lz"
...
SECTION "Haunter Mini Icon", ROMX
HaunterMini::     INCBIN "gfx/minis/haunter.2bpp.lz"
HaunterMiniMask:: INCBIN "gfx/minis/haunter_mask.1bpp.lz"
HaunterIcon::     INCBIN "gfx/icons/haunter.2bpp.lz"

SECTION "Gengar Mini Icon", ROMX
GengarMini::     INCBIN "gfx/minis/gengar.2bpp.lz"
GengarMiniMask:: INCBIN "gfx/minis/gengar_mask.1bpp.lz"
GengarIcon::     INCBIN "gfx/icons/gengar.2bpp.lz"

SECTION "Onix Mini Icon", ROMX
OnixMini::     INCBIN "gfx/minis/onix.2bpp.lz"
...
SECTION "Koffing Mini Icon", ROMX
KoffingMini::     INCBIN "gfx/minis/koffing.2bpp.lz"
KoffingMiniMask:: INCBIN "gfx/minis/koffing_mask.1bpp.lz"
KoffingIcon::     INCBIN "gfx/icons/koffing.2bpp.lz"

SECTION "Weezing Mini Icon", ROMX
WeezingMini::     INCBIN "gfx/minis/weezing.2bpp.lz"
...
SECTION "Kangaskhan Mini Icon", ROMX
KangaskhanMini::     INCBIN "gfx/minis/kangaskhan.2bpp.lz"
KangaskhanMiniMask:: INCBIN "gfx/minis/kangaskhan_mask.1bpp.lz"
KangaskhanIcon::     INCBIN "gfx/icons/kangaskhan.2bpp.lz"

SECTION "Horsea Mini Icon", ROMX
HorseaMini::     INCBIN "gfx/minis/horsea.2bpp.lz"
HorseaMiniMask:: INCBIN "gfx/minis/horsea_mask.1bpp.lz"
HorseaIcon::     INCBIN "gfx/icons/horsea.2bpp.lz"

SECTION "Seadra Mini Icon", ROMX
SeadraMini::     INCBIN "gfx/minis/seadra.2bpp.lz"
...
SECTION "Starmie Mini Icon", ROMX
StarmieMini::     INCBIN "gfx/minis/starmie.2bpp.lz"
StarmieMiniMask:: INCBIN "gfx/minis/starmie_mask.1bpp.lz"
StarmieIcon::     INCBIN "gfx/icons/starmie.2bpp.lz"

SECTION "MrMime Mini Icon", ROMX
MrMimeMini::     INCBIN "gfx/minis/mr__mime.2bpp.lz"
MrMimeMiniMask:: INCBIN "gfx/minis/mr__mime_mask.1bpp.lz"
MrMimeIcon::     INCBIN "gfx/icons/mr__mime.2bpp.lz"

SECTION "Scyther Mini Icon", ROMX
ScytherMini::     INCBIN "gfx/minis/scyther.2bpp.lz"
...
SECTION "Magmar Mini Icon", ROMX
MagmarMini::     INCBIN "gfx/minis/magmar.2bpp.lz"
MagmarMiniMask:: INCBIN "gfx/minis/magmar_mask.1bpp.lz"
MagmarIcon::     INCBIN "gfx/icons/magmar.2bpp.lz"

SECTION "Pinsir Mini Icon", ROMX
PinsirMini::     INCBIN "gfx/minis/pinsir.2bpp.lz"
...
SECTION "Ditto Mini Icon", ROMX
DittoMini::     INCBIN "gfx/minis/ditto.2bpp.lz"
DittoMiniMask:: INCBIN "gfx/minis/ditto_mask.1bpp.lz"
DittoIcon::     INCBIN "gfx/icons/ditto.2bpp.lz"

SECTION "Eevee Mini Icon", ROMX
EeveeMini::     INCBIN "gfx/minis/eevee.2bpp.lz"
EeveeMiniMask:: INCBIN "gfx/minis/eevee_mask.1bpp.lz"
EeveeIcon::     INCBIN "gfx/icons/eevee.2bpp.lz"

SECTION "Vaporeon Mini Icon", ROMX
VaporeonMini::     INCBIN "gfx/minis/vaporeon.2bpp.lz"
VaporeonMiniMask:: INCBIN "gfx/minis/vaporeon_mask.1bpp.lz"
VaporeonIcon::     INCBIN "gfx/icons/vaporeon.2bpp.lz"

SECTION "Jolteon Mini Icon", ROMX
JolteonMini::     INCBIN "gfx/minis/jolteon.2bpp.lz"
JolteonMiniMask:: INCBIN "gfx/minis/jolteon_mask.1bpp.lz"
JolteonIcon::     INCBIN "gfx/icons/jolteon.2bpp.lz"

SECTION "Flareon Mini Icon", ROMX
FlareonMini::     INCBIN "gfx/minis/flareon.2bpp.lz"
...
SECTION "Dragonair Mini Icon", ROMX
DragonairMini::     INCBIN "gfx/minis/dragonair.2bpp.lz"
DragonairMiniMask:: INCBIN "gfx/minis/dragonair_mask.1bpp.lz"
DragonairIcon::     INCBIN "gfx/icons/dragonair.2bpp.lz"

SECTION "Dragonite Mini Icon", ROMX
DragoniteMini::     INCBIN "gfx/minis/dragonite.2bpp.lz"
...
ChinchouMini::     INCBIN "gfx/minis/chinchou.2bpp.lz"
ChinchouMiniMask:: INCBIN "gfx/minis/chinchou_mask.1bpp.lz"
ChinchouIcon::     INCBIN "gfx/icons/chinchou.2bpp.lz"

SECTION "Lanturn Mini Icon", ROMX
LanturnMini::     INCBIN "gfx/minis/lanturn.2bpp.lz"
LanturnMiniMask:: INCBIN "gfx/minis/lanturn_mask.1bpp.lz"
LanturnIcon::     INCBIN "gfx/icons/lanturn.2bpp.lz"

SECTION "Pichu Mini Icon", ROMX
PichuMini::     INCBIN "gfx/minis/pichu.2bpp.lz"
PichuMiniMask:: INCBIN "gfx/minis/pichu_mask.1bpp.lz"
PichuIcon::     INCBIN "gfx/icons/pichu.2bpp.lz"

SECTION "Cleffa Mini Icon", ROMX
CleffaMini::     INCBIN "gfx/minis/cleffa.2bpp.lz"
CleffaMiniMask:: INCBIN "gfx/minis/cleffa_mask.1bpp.lz"
CleffaIcon::     INCBIN "gfx/icons/cleffa.2bpp.lz"

SECTION "Igglybuff Mini Icon", ROMX
IgglybuffMini::     INCBIN "gfx/minis/igglybuff.2bpp.lz"
IgglybuffMiniMask:: INCBIN "gfx/minis/igglybuff_mask.1bpp.lz"
IgglybuffIcon::     INCBIN "gfx/icons/igglybuff.2bpp.lz"

SECTION "Togepi Mini Icon", ROMX
TogepiMini::     INCBIN "gfx/minis/togepi.2bpp.lz"
TogepiMiniMask:: INCBIN "gfx/minis/togepi_mask.1bpp.lz"
TogepiIcon::     INCBIN "gfx/icons/togepi.2bpp.lz"

SECTION "Togetic Mini Icon", ROMX
TogeticMini::     INCBIN "gfx/minis/togetic.2bpp.lz"
...
SECTION "Flaaffy Mini Icon", ROMX
FlaaffyMini::     INCBIN "gfx/minis/flaaffy.2bpp.lz"
FlaaffyMiniMask:: INCBIN "gfx/minis/flaaffy_mask.1bpp.lz"
FlaaffyIcon::     INCBIN "gfx/icons/flaaffy.2bpp.lz"

SECTION "Ampharos Mini Icon", ROMX
...
MarillMiniMask:: INCBIN "gfx/minis/marill_mask.1bpp.lz"
MarillIcon::     INCBIN "gfx/icons/marill.2bpp.lz"

SECTION "Azumarill Mini Icon", ROMX
AzumarillMini::     INCBIN "gfx/minis/azumarill.2bpp.lz"
AzumarillMiniMask:: INCBIN "gfx/minis/azumarill_mask.1bpp.lz"
...
SECTION "Sunflora Mini Icon", ROMX
SunfloraMini::     INCBIN "gfx/minis/sunflora.2bpp.lz"
SunfloraMiniMask:: INCBIN "gfx/minis/sunflora_mask.1bpp.lz"
SunfloraIcon::     INCBIN "gfx/icons/sunflora.2bpp.lz"

SECTION "Yanma Mini Icon", ROMX
YanmaMini::     INCBIN "gfx/minis/yanma.2bpp.lz"
...
SECTION "Umbreon Mini Icon", ROMX
UmbreonMini::     INCBIN "gfx/minis/umbreon.2bpp.lz"
UmbreonMiniMask:: INCBIN "gfx/minis/umbreon_mask.1bpp.lz"
UmbreonIcon::     INCBIN "gfx/icons/umbreon.2bpp.lz"

SECTION "Murkrow Mini Icon", ROMX
MurkrowMini::     INCBIN "gfx/minis/murkrow.2bpp.lz"
MurkrowMiniMask:: INCBIN "gfx/minis/murkrow_mask.1bpp.lz"
MurkrowIcon::     INCBIN "gfx/icons/murkrow.2bpp.lz"

SECTION "Slowking Mini Icon", ROMX
SlowkingMini::     INCBIN "gfx/minis/slowking.2bpp.lz"
SlowkingMiniMask:: INCBIN "gfx/minis/slowking_mask.1bpp.lz"
SlowkingIcon::     INCBIN "gfx/icons/slowking.2bpp.lz"

SECTION "Misdreavus Mini Icon", ROMX
MisdreavusMini::     INCBIN "gfx/minis/misdreavus.2bpp.lz"
MisdreavusMiniMask:: INCBIN "gfx/minis/misdreavus_mask.1bpp.lz"
MisdreavusIcon::     INCBIN "gfx/icons/misdreavus.2bpp.lz"

SECTION "UnownA Mini Icon", ROMX
UnownAMini::     INCBIN "gfx/minis/unown_a.2bpp.lz"
...
DunsparceIcon::     INCBIN "gfx/icons/dunsparce.2bpp.lz"

SECTION "Gligar Mini Icon", ROMX
GligarMini::     INCBIN "gfx/minis/gligar.2bpp.lz"
GligarMiniMask:: INCBIN "gfx/minis/gligar_mask.1bpp.lz"
GligarIcon::     INCBIN "gfx/icons/gligar.2bpp.lz"

SECTION "Steelix Mini Icon", ROMX
SteelixMini::     INCBIN "gfx/minis/steelix.2bpp.lz"
SteelixMiniMask:: INCBIN "gfx/minis/steelix_mask.1bpp.lz"
SteelixIcon::     INCBIN "gfx/icons/steelix.2bpp.lz"

SECTION "Snubbull Mini Icon", ROMX
SnubbullMini::     INCBIN "gfx/minis/snubbull.2bpp.lz"
SnubbullMiniMask:: INCBIN "gfx/minis/snubbull_mask.1bpp.lz"
SnubbullIcon::     INCBIN "gfx/icons/snubbull.2bpp.lz"

SECTION "Granbull Mini Icon", ROMX
GranbullMini::     INCBIN "gfx/minis/granbull.2bpp.lz"
...
HeracrossMiniMask:: INCBIN "gfx/minis/heracross_mask.1bpp.lz"
HeracrossIcon::     INCBIN "gfx/icons/heracross.2bpp.lz"

SECTION "Sneasel Mini Icon", ROMX
SneaselMini::     INCBIN "gfx/minis/sneasel.2bpp.lz"
...
SECTION "Piloswine Mini Icon", ROMX
PiloswineMini::     INCBIN "gfx/minis/piloswine.2bpp.lz"
PiloswineMiniMask:: INCBIN "gfx/minis/piloswine_mask.1bpp.lz"
PiloswineIcon::     INCBIN "gfx/icons/piloswine.2bpp.lz"

SECTION "Corsola Mini Icon", ROMX
CorsolaMini::     INCBIN "gfx/minis/corsola.2bpp.lz"
...
DelibirdMiniMask:: INCBIN "gfx/minis/delibird_mask.1bpp.lz"
DelibirdIcon::     INCBIN "gfx/icons/delibird.2bpp.lz"

SECTION "Mantine Mini Icon", ROMX
MantineMini::     INCBIN "gfx/minis/mantine.2bpp.lz"
MantineMiniMask:: INCBIN "gfx/minis/mantine_mask.1bpp.lz"
MantineIcon::     INCBIN "gfx/icons/mantine.2bpp.lz"

SECTION "Skarmory Mini Icon", ROMX
SkarmoryMini::     INCBIN "gfx/minis/skarmory.2bpp.lz"
SkarmoryMiniMask:: INCBIN "gfx/minis/skarmory_mask.1bpp.lz"
SkarmoryIcon::     INCBIN "gfx/icons/skarmory.2bpp.lz"

SECTION "Houndour Mini Icon", ROMX
HoundourMini::     INCBIN "gfx/minis/houndour.2bpp.lz"
HoundourMiniMask:: INCBIN "gfx/minis/houndour_mask.1bpp.lz"
HoundourIcon::     INCBIN "gfx/icons/houndour.2bpp.lz"

SECTION "Houndoom Mini Icon", ROMX
HoundoomMini::     INCBIN "gfx/minis/houndoom.2bpp.lz"
HoundoomMiniMask:: INCBIN "gfx/minis/houndoom_mask.1bpp.lz"
HoundoomIcon::     INCBIN "gfx/icons/houndoom.2bpp.lz"

SECTION "Kingdra Mini Icon", ROMX
KingdraMini::     INCBIN "gfx/minis/kingdra.2bpp.lz"
...
SECTION "Magby Mini Icon", ROMX
MagbyMini::     INCBIN "gfx/minis/magby.2bpp.lz"
...
SECTION "Pupitar Mini Icon", ROMX
PupitarMini::     INCBIN "gfx/minis/pupitar.2bpp.lz"
PupitarMiniMask:: INCBIN "gfx/minis/pupitar_mask.1bpp.lz"
PupitarIcon::     INCBIN "gfx/icons/pupitar.2bpp.lz"

SECTION "Tyranitar Mini Icon", ROMX
TyranitarMini::     INCBIN "gfx/minis/tyranitar.2bpp.lz"
...
MismagiusIcon::     INCBIN "gfx/icons/mismagius.2bpp.lz"

SECTION "Honchkrow Mini Icon", ROMX
HonchkrowMini::     INCBIN "gfx/minis/honchkrow.2bpp.lz"
...
SECTION "Magnezone Mini Icon", ROMX
MagnezoneMini::     INCBIN "gfx/minis/magnezone.2bpp.lz"
MagnezoneMiniMask:: INCBIN "gfx/minis/magnezone_mask.1bpp.lz"
MagnezoneIcon::     INCBIN "gfx/icons/magnezone.2bpp.lz"

SECTION "Lickilicky Mini Icon", ROMX
LickilickyMini::     INCBIN "gfx/minis/lickilicky.2bpp.lz"
...
SECTION "Electivire Mini Icon", ROMX
ElectivireMini::     INCBIN "gfx/minis/electivire.2bpp.lz"
ElectivireMiniMask:: INCBIN "gfx/minis/electivire_mask.1bpp.lz"
ElectivireIcon::     INCBIN "gfx/icons/electivire.2bpp.lz"

SECTION "Magmortar Mini Icon", ROMX
MagmortarMini::     INCBIN "gfx/minis/magmortar.2bpp.lz"
MagmortarMiniMask:: INCBIN "gfx/minis/magmortar_mask.1bpp.lz"
MagmortarIcon::     INCBIN "gfx/icons/magmortar.2bpp.lz"

SECTION "Togekiss Mini Icon", ROMX
TogekissMini::     INCBIN "gfx/minis/togekiss.2bpp.lz"
TogekissMiniMask:: INCBIN "gfx/minis/togekiss_mask.1bpp.lz"
TogekissIcon::     INCBIN "gfx/icons/togekiss.2bpp.lz"

SECTION "Yanmega Mini Icon", ROMX
YanmegaMini::     INCBIN "gfx/minis/yanmega.2bpp.lz"
YanmegaMiniMask:: INCBIN "gfx/minis/yanmega_mask.1bpp.lz"
YanmegaIcon::     INCBIN "gfx/icons/yanmega.2bpp.lz"

SECTION "Leafeon Mini Icon", ROMX
LeafeonMini::     INCBIN "gfx/minis/leafeon.2bpp.lz"
LeafeonMiniMask:: INCBIN "gfx/minis/leafeon_mask.1bpp.lz"
LeafeonIcon::     INCBIN "gfx/icons/leafeon.2bpp.lz"

SECTION "Glaceon Mini Icon", ROMX
GlaceonMini::     INCBIN "gfx/minis/glaceon.2bpp.lz"
GlaceonMiniMask:: INCBIN "gfx/minis/glaceon_mask.1bpp.lz"
GlaceonIcon::     INCBIN "gfx/icons/glaceon.2bpp.lz"

SECTION "Gliscor Mini Icon", ROMX
GliscorMini::     INCBIN "gfx/minis/gliscor.2bpp.lz"
GliscorMiniMask:: INCBIN "gfx/minis/gliscor_mask.1bpp.lz"
GliscorIcon::     INCBIN "gfx/icons/gliscor.2bpp.lz"

SECTION "Mamoswine Mini Icon", ROMX
...
SECTION "UnownC Mini Icon", ROMX
UnownCMini::     INCBIN "gfx/minis/unown_c.2bpp.lz"
UnownCMiniMask:: INCBIN "gfx/minis/unown_c_mask.1bpp.lz"
UnownCIcon::     INCBIN "gfx/icons/unown_c.2bpp.lz"

SECTION "UnownD Mini Icon", ROMX
UnownDMini::     INCBIN "gfx/minis/unown_d.2bpp.lz"
UnownDMiniMask:: INCBIN "gfx/minis/unown_d_mask.1bpp.lz"
UnownDIcon::     INCBIN "gfx/icons/unown_d.2bpp.lz"

SECTION "UnownE Mini Icon", ROMX
UnownEMini::     INCBIN "gfx/minis/unown_e.2bpp.lz"
UnownEMiniMask:: INCBIN "gfx/minis/unown_e_mask.1bpp.lz"
UnownEIcon::     INCBIN "gfx/icons/unown_e.2bpp.lz"

SECTION "UnownF Mini Icon", ROMX
UnownFMini::     INCBIN "gfx/minis/unown_f.2bpp.lz"
UnownFMiniMask:: INCBIN "gfx/minis/unown_f_mask.1bpp.lz"
UnownFIcon::     INCBIN "gfx/icons/unown_f.2bpp.lz"

SECTION "UnownG Mini Icon", ROMX
UnownGMini::     INCBIN "gfx/minis/unown_g.2bpp.lz"
UnownGMiniMask:: INCBIN "gfx/minis/unown_g_mask.1bpp.lz"
UnownGIcon::     INCBIN "gfx/icons/unown_g.2bpp.lz"

SECTION "UnownH Mini Icon", ROMX
UnownHMini::     INCBIN "gfx/minis/unown_h.2bpp.lz"
UnownHMiniMask:: INCBIN "gfx/minis/unown_h_mask.1bpp.lz"
UnownHIcon::     INCBIN "gfx/icons/unown_h.2bpp.lz"

SECTION "UnownI Mini Icon", ROMX
UnownIMini::     INCBIN "gfx/minis/unown_i.2bpp.lz"
UnownIMiniMask:: INCBIN "gfx/minis/unown_i_mask.1bpp.lz"
UnownIIcon::     INCBIN "gfx/icons/unown_i.2bpp.lz"

SECTION "UnownJ Mini Icon", ROMX
UnownJMini::     INCBIN "gfx/minis/unown_j.2bpp.lz"
UnownJMiniMask:: INCBIN "gfx/minis/unown_j_mask.1bpp.lz"
UnownJIcon::     INCBIN "gfx/icons/unown_j.2bpp.lz"

SECTION "UnownK Mini Icon", ROMX
UnownKMini::     INCBIN "gfx/minis/unown_k.2bpp.lz"
UnownKMiniMask:: INCBIN "gfx/minis/unown_k_mask.1bpp.lz"
UnownKIcon::     INCBIN "gfx/icons/unown_k.2bpp.lz"

SECTION "UnownL Mini Icon", ROMX
UnownLMini::     INCBIN "gfx/minis/unown_l.2bpp.lz"
UnownLMiniMask:: INCBIN "gfx/minis/unown_l_mask.1bpp.lz"
UnownLIcon::     INCBIN "gfx/icons/unown_l.2bpp.lz"

SECTION "UnownM Mini Icon", ROMX
UnownMMini::     INCBIN "gfx/minis/unown_m.2bpp.lz"
UnownMMiniMask:: INCBIN "gfx/minis/unown_m_mask.1bpp.lz"
UnownMIcon::     INCBIN "gfx/icons/unown_m.2bpp.lz"

SECTION "UnownN Mini Icon", ROMX
UnownNMini::     INCBIN "gfx/minis/unown_n.2bpp.lz"
UnownNMiniMask:: INCBIN "gfx/minis/unown_n_mask.1bpp.lz"
UnownNIcon::     INCBIN "gfx/icons/unown_n.2bpp.lz"

SECTION "UnownO Mini Icon", ROMX
UnownOMini::     INCBIN "gfx/minis/unown_o.2bpp.lz"
UnownOMiniMask:: INCBIN "gfx/minis/unown_o_mask.1bpp.lz"
UnownOIcon::     INCBIN "gfx/icons/unown_o.2bpp.lz"

SECTION "UnownP Mini Icon", ROMX
UnownPMini::     INCBIN "gfx/minis/unown_p.2bpp.lz"
UnownPMiniMask:: INCBIN "gfx/minis/unown_p_mask.1bpp.lz"
UnownPIcon::     INCBIN "gfx/icons/unown_p.2bpp.lz"

SECTION "UnownQ Mini Icon", ROMX
UnownQMini::     INCBIN "gfx/minis/unown_q.2bpp.lz"
UnownQMiniMask:: INCBIN "gfx/minis/unown_q_mask.1bpp.lz"
UnownQIcon::     INCBIN "gfx/icons/unown_q.2bpp.lz"

SECTION "UnownR Mini Icon", ROMX
UnownRMini::     INCBIN "gfx/minis/unown_r.2bpp.lz"
UnownRMiniMask:: INCBIN "gfx/minis/unown_r_mask.1bpp.lz"
UnownRIcon::     INCBIN "gfx/icons/unown_r.2bpp.lz"

SECTION "UnownS Mini Icon", ROMX
UnownSMini::     INCBIN "gfx/minis/unown_s.2bpp.lz"
UnownSMiniMask:: INCBIN "gfx/minis/unown_s_mask.1bpp.lz"
UnownSIcon::     INCBIN "gfx/icons/unown_s.2bpp.lz"

SECTION "UnownT Mini Icon", ROMX
UnownTMini::     INCBIN "gfx/minis/unown_t.2bpp.lz"
UnownTMiniMask:: INCBIN "gfx/minis/unown_t_mask.1bpp.lz"
UnownTIcon::     INCBIN "gfx/icons/unown_t.2bpp.lz"

SECTION "UnownU Mini Icon", ROMX
UnownUMini::     INCBIN "gfx/minis/unown_u.2bpp.lz"
UnownUMiniMask:: INCBIN "gfx/minis/unown_u_mask.1bpp.lz"
UnownUIcon::     INCBIN "gfx/icons/unown_u.2bpp.lz"

SECTION "UnownV Mini Icon", ROMX
UnownVMini::     INCBIN "gfx/minis/unown_v.2bpp.lz"
UnownVMiniMask:: INCBIN "gfx/minis/unown_v_mask.1bpp.lz"
UnownVIcon::     INCBIN "gfx/icons/unown_v.2bpp.lz"

SECTION "UnownW Mini Icon", ROMX
UnownWMini::     INCBIN "gfx/minis/unown_w.2bpp.lz"
UnownWMiniMask:: INCBIN "gfx/minis/unown_w_mask.1bpp.lz"
UnownWIcon::     INCBIN "gfx/icons/unown_w.2bpp.lz"

SECTION "UnownX Mini Icon", ROMX
UnownXMini::     INCBIN "gfx/minis/unown_x.2bpp.lz"
UnownXMiniMask:: INCBIN "gfx/minis/unown_x_mask.1bpp.lz"
UnownXIcon::     INCBIN "gfx/icons/unown_x.2bpp.lz"

SECTION "UnownY Mini Icon", ROMX
UnownYMini::     INCBIN "gfx/minis/unown_y.2bpp.lz"
UnownYMiniMask:: INCBIN "gfx/minis/unown_y_mask.1bpp.lz"
UnownYIcon::     INCBIN "gfx/icons/unown_y.2bpp.lz"

SECTION "UnownZ Mini Icon", ROMX
UnownZMini::     INCBIN "gfx/minis/unown_z.2bpp.lz"
UnownZMiniMask:: INCBIN "gfx/minis/unown_z_mask.1bpp.lz"
UnownZIcon::     INCBIN "gfx/icons/unown_z.2bpp.lz"

SECTION "UnownExclamation Mini Icon", ROMX
...
SECTION "UnownQuestion Mini Icon", ROMX
...
VulpixAlolanIcon::     INCBIN "gfx/icons/vulpix_alolan.2bpp.lz"

SECTION "NinetalesAlolan Mini Icon", ROMX
...
MeowthAlolanMiniMask:: INCBIN "gfx/minis/meowth_alolan_mask.1bpp.lz"
MeowthAlolanIcon::     INCBIN "gfx/icons/meowth_alolan.2bpp.lz"

SECTION "PersianAlolan Mini Icon", ROMX
PersianAlolanMini::     INCBIN "gfx/minis/persian_alolan.2bpp.lz"
PersianAlolanMiniMask:: INCBIN "gfx/minis/persian_alolan_mask.1bpp.lz"
PersianAlolanIcon::     INCBIN "gfx/icons/persian_alolan.2bpp.lz"

SECTION "GeodudeAlolan Mini Icon", ROMX
GeodudeAlolanMini::     INCBIN "gfx/minis/geodude_alolan.2bpp.lz"
GeodudeAlolanMiniMask:: INCBIN "gfx/minis/geodude_alolan_mask.1bpp.lz"
GeodudeAlolanIcon::     INCBIN "gfx/icons/geodude_alolan.2bpp.lz"

SECTION "GravelerAlolan Mini Icon", ROMX
GravelerAlolanMini::     INCBIN "gfx/minis/graveler_alolan.2bpp.lz"
GravelerAlolanMiniMask:: INCBIN "gfx/minis/graveler_alolan_mask.1bpp.lz"
GravelerAlolanIcon::     INCBIN "gfx/icons/graveler_alolan.2bpp.lz"

SECTION "GolemAlolan Mini Icon", ROMX
GolemAlolanMini::     INCBIN "gfx/minis/golem_alolan.2bpp.lz"
GolemAlolanMiniMask:: INCBIN "gfx/minis/golem_alolan_mask.1bpp.lz"
GolemAlolanIcon::     INCBIN "gfx/icons/golem_alolan.2bpp.lz"

SECTION "GrimerAlolan Mini Icon", ROMX
GrimerAlolanMini::     INCBIN "gfx/minis/grimer_alolan.2bpp.lz"
GrimerAlolanMiniMask:: INCBIN "gfx/minis/grimer_alolan_mask.1bpp.lz"
GrimerAlolanIcon::     INCBIN "gfx/icons/grimer_alolan.2bpp.lz"

SECTION "MukAlolan Mini Icon", ROMX
...
SECTION "PonytaGalarian Mini Icon", ROMX
...
PonytaGalarianIcon::     INCBIN "gfx/icons/ponyta_galarian.2bpp.lz"

SECTION "RapidashGalarian Mini Icon", ROMX
...
RapidashGalarianIcon::     INCBIN "gfx/icons/rapidash_galarian.2bpp.lz"

SECTION "SlowpokeGalarian Mini Icon", ROMX
...
SlowpokeGalarianIcon::     INCBIN "gfx/icons/slowpoke_galarian.2bpp.lz"

SECTION "SlowbroGalarian Mini Icon", ROMX
...
SlowkingGalarianMiniMask:: INCBIN "gfx/minis/slowking_galarian_mask.1bpp.lz"
SlowkingGalarianIcon::     INCBIN "gfx/icons/slowking_galarian.2bpp.lz"

SECTION "CorsolaGalarian Mini Icon", ROMX
CorsolaGalarianMini::     INCBIN "gfx/minis/corsola_galarian.2bpp.lz"
...
GrowlitheHisuianIcon::     INCBIN "gfx/icons/growlithe_hisuian.2bpp.lz"

SECTION "ArcanineHisuian Mini Icon", ROMX
